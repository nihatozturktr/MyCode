...
public class C04_ExplicitNarrowing {
	...
	public static void main(String[] args) {
		...
		// hatasi verir
		// hatayi gidermek icin buyuk data turundeki deger'in onune manule onayimizi
		// gosteren
		// (short) yazilir
		...
		// deger virgullu oildugundan ve int'da ondalikli kisim olmadigindan java
		// ondalikli kismi keser
		...
		System.out.println(sayi6/sayi7);//6,75 islem yapilan sayilardan daha genis data turune sahip olan 
